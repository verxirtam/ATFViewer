 ...
 * =====================================================================================
 *
 *       Filename:  SceanLatLongFlow.cpp
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  2016年11月24日 23時21分07秒
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
const float SceanLatLongFlow::pi = 3.141592653589793f;

void SceanLatLongFlow::init(void)
{
...
void SceanLatLongFlow::setMatrix(void)
{
...
void SceanLatLongFlow::resize(GLFWwindow* window, int w, int h)
{
...
void SceanLatLongFlow::keyboard(GLFWwindow* window, int key, int scancode, int action, int mods)
{
...
void SceanLatLongFlow::joystickInput(Joystick& joystick)
{
	//ジョイスティックの状況を取得する
